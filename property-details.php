...
<head>
    ...
    <!-- Title -->
    <title> Uncle D real Estate Properties - Property Details</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <div class="room-text">
                            <h1>Silver Single Room<span>$2000 / per day</span></h1>
                            <div id='carousel-slider' class='carousel slide' data-ride='carousel'>
                                <div class='carousel-outer'>
                                    ...
                                    <!-- sag sol -->
                                    <a class='left crousel_left carousel-control' href='#carousel-slider' data-slide='prev'>
                                        <span class='fa fa-angle-left'></span>
                                    </a>
                                    <a class='right crousel_right carousel-control' href='#carousel-slider' data-slide='next'>
                                        <span class='fa fa-angle-right'></span>
                                    </a>
                                </div>
                            </div>
                            <h2>Our Rooms come Standard</h2>
                            ...
                            <div class="allroom-button">
                                <a href="" class="readmore-button">Book Now</a>
                            </div>
                        </div>
                    </div>
